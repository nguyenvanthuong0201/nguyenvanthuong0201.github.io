...
Winwheel.prototype.startAnimation = function() {
    if (this.animation) {
        ...
        var a = Array(null);
        var numbersCustomer = [4912, 4964, 4940, 2017, 2019, 2017, 2019,5014, 2017, 2019,
             5014, 4940, 2017, 2019, 2017, 2019,5014, 2017, 2019, 5014, 5003,4972,4997,4845,4859,4859,1904, 1917,1875];
        var random = Math.floor(Math.random() * numbersCustomer.length);
        a[this.animation.propertyName] = numbersCustomer[random];
